...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        labelOS->setGeometry(QRect(180, 10, 301, 101));
        QFont font;
        font.setPointSize(64);
        labelOS->setFont(font);
        labelOS->setAlignment(Qt::AlignmentFlag::AlignCenter);
        label = new RingLoop(centralwidget);
        label->setObjectName("label");
        label->setGeometry(QRect(20, 210, 41, 41));
        label_2 = new RingLoop(centralwidget);
        label_2->setObjectName("label_2");
        label_2->setGeometry(QRect(90, 210, 41, 41));
        label_3 = new RingLoop(centralwidget);
        label_3->setObjectName("label_3");
        label_3->setGeometry(QRect(20, 270, 41, 41));
